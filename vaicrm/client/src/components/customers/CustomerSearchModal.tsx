...
import { agentApi } from "@/lib/agentApi"; // Using agentApi to access userDetailsByType
...
export default function CustomerSearchModal({ isOpen, onClose, onSelect }: Props) {
  ...
  const fetchCustomers = async () => {
    ...
    try {
      // Updated Payload to match Requirement 1
      const payload: any = {
        type: "Customer",      // Requirement: type is Customer
        isSubCollection: "Y",  // Requirement: isSubCollection is Y
      ...
      // Mapping Logic similar to ParentAgentSearchModal
