...
export default function SubagentAgentTransferDelivery() {
    ...
    const columns: DataTableColumn<StockItem>[] = [
        ...
        { key: "transferFrom", label: "From Sub-agent" },
                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                    <div className="flex-1">
                        <CardTitle className="flex items-center gap-2 text-lg">
                            ...
                            Pending Deliveries (Subagent to Agent)
                        ...
                        <CardDescription>Upload serial numbers for approved agent To Agent transfers to complete delivery.</CardDescription>
                    </div>
