...
export default function StockTransferHistory() {
  ...
  // API Query with Type "ST"
  const { data: rawData = [], isLoading } = useStockHistory({
    ...apiParams,
    type: "ST"
  });

  // Client-Side Processing (Aggregation + Material Filter)
      ...
      <Card>
        <CardContent className="p-0">
          <DataTable
            ...
            subtitle="Track stock transfer requests"
        ...
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          ...
          {detailsRow && (
            <div className="space-y-4 text-sm">
              ...
              {/* Header Info - Updated to include Store Locations */}
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 bg-gray-50 p-3 rounded border">
                ...
                <div className="col-span-2 md:col-span-4">
                  ...
                  <Badge className="mt-1 h-5 text-[10px]">{detailsRow.status}</Badge>
                </div>
              </div>
