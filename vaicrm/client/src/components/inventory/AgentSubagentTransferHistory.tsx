...
export default function AgentSubagentTransferHistory() {
    ...
    const { data, isLoading, isError, error, refetch } = useQuery({
        queryKey: ["agent-subagent-transfer-history", debouncedFilters, loggedInUserBpId, isAdminUser],
        staleTime: 15_000,
        ...
        queryFn: () => {
            ...
            return apiRequest('/inventory/agent-subagent-transfer-history', 'POST', payload);
        },
    });
